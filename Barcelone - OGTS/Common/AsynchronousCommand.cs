...
namespace Barcelone___OGTS.Common
{
    ...
    public class AsynchronousCommand : Command, INotifyPropertyChanged
    {
        ...
        public AsynchronousCommand(Action action, Predicate<object> canExecute)
        ...
        public AsynchronousCommand(Action<object> parameterizedAction, Predicate<object> canExecute)
